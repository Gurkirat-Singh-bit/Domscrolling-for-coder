...
export function Footer({
  ...
  return (
    <footer className="pb-6 pt-8 lg:pb-8 lg:pt-12 bg-black text-white border-t border-white/10">
            ...
            {socialLinks.map((link, i) => (
              <li key={i}>
                <Button
                  variant="secondary"
                  size="icon"
                  className="h-10 w-10 rounded-full bg-white/10 text-white hover:bg-white/20 border-white/10"
                  asChild
                >
